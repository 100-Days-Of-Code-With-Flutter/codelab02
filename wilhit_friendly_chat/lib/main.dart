  ...
  Widget build(BuildContext context) {
    return SizeTransition(
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(8.0, 4.0, 8.0, 5.0),
          ...
          children: [
            Container(
              ...
              child: CircleAvatar(
                ...
                child: Text(_name[0], style: TextStyle(fontSize: 30.0, color: Colors.white),),
...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('WilhitFriendlyChat', style: TextStyle(color: Colors.white, fontSize: 25.0),),
